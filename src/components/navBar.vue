<template>
    <div class="navbar" style="width: 100%;">
        <div class="contentBar">
            ...
            <div class="navMenu noSelect"  ref="dropdownMenu">

                <div class="userProfile" style="display: flex;">
                    <div style="display:flex;" v-on:click="redirectToPayment">
                        <cart></cart>

                    </div>
                        
                    <div v-on:click="dropdownVisilibity == false ? dropdownVisilibity = true : dropdownVisilibity = false">
...
export default {
    ...
    methods:{
        ...
        redirectToPayment() {
            this.$router.push('/paymentProcess')
        },
    },
    created () {
